...
You can find the BuildId, Feature set and user agent [here](https://rocketleague-api.com/api/v1/info).

| Key | Value | Authenticated only |
|-|-|-|
| User-Agent | RL Win/xxxxxx.xxxxx.xxxxxx gzip | No |
| PsyBuildID | xxxxxxxxx | No |
